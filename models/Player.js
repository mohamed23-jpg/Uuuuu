...
const playerSchema = new mongoose.Schema(
  {
    // الهوية الأساسية
    playerId: { type: String, unique: true, required: true }, // 12 رقم يبدأ بـ 238
    nickname: { type: String, required: true, trim: true, minlength: 3, maxlength: 20 },
    avatar: { type: String, default: "dino" }, // dog/cat/dino/fox/lion/bear
    customAvatar: { type: String, default: null }, // رابط URL
